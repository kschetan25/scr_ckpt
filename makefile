...
all: test_api test_api_multiple test_interpose test_interpose_multiple test_ckpt_C test_ckpt_F test_scr

clean:
	rm -rf *.o test_api test_api_multiple test_interpose test_interpose_multiple test_ckpt_C test_scr
...
test_scr: test_scr.c
	$(MPIF90) $(OPT) $(F90FLAGS) $(INCLUDES) -o test_scr test_scr.c \
	  $(LDFLAGS) -lscrf $(LIBDIR)